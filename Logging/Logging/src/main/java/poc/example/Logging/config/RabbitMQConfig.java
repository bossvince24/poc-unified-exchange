package poc.example.Logging.config;
...
public class RabbitMQConfig {
	...
	@Bean
	public Binding loggingQueueBinding() {
		return BindingBuilder.bind(loggingQueue()).to(loggingExchange()).with(routingKey);
	}

	@Bean
	public Binding depositToLoggingBinding() {
		return new Binding(unifiedExchange, Binding.DestinationType.EXCHANGE, depositExchange, routingKey, null);
	}

	@Bean
	public Binding withdrawalToLoggingBinding() {
